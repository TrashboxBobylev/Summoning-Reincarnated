...
public class Assets {
	...
	public static class Environment {
		...
		public static final String TILES_ABYSS2 = "environment/tiles_abysschallenge.png";
	...
	public static class Interfaces {
		...
		public static final String SUMM_ICONS       = "interfaces/summ_change_icons.png";
	}
	...
	public static class Sounds {
		...
		public static final String BONG    = "sounds/bong.mp3";
        public static final String LIGHTNING_BOLT = "sounds/lightning_bolt.mp3";
		...
		public static final String[] all = new String[]{
				...
				HIT, MISS, HIT_SLASH, HIT_STAB, HIT_CRUSH, HIT_MAGIC, HIT_STRONG, HIT_PARRY, HIT_GONG,
				HIT_ARROW, ATK_SPIRITBOW, ATK_CROSSBOW, HEALTH_WARN, HEALTH_CRITICAL,

				DESCEND, EAT, READ, LULLABY, DRINK, SHATTER, ZAP, LIGHTNING, LEVELUP, DEATH,
				CHALLENGE, CURSED, TRAP, EVOKE, TOMB, ALERT, MELD, BOSS, BLAST, PLANT, RAY, BEACON,
				TELEPORT, CHARMS, MASTERY, PUFF, ROCKS, BURNING, FALLING, GHOST, SECRET, BONES,
				BEE, DEGRADE, MIMIC, DEBUFF, CHARGEUP, GAS, CHAINS, SCAN, SHEEP, MINE, BONG, LIGHTNING_BOLT
		};
	}
	...
	public static class Splashes {
		...
		public static final String ABYSS    = "splashes/abyss.jpg";
	...
	public static class Sprites {
		...
		public static final String RATTLESNAKE       = "sprites/rattlesnake.png";
		public static final String CROW              = "sprites/crow.png";
