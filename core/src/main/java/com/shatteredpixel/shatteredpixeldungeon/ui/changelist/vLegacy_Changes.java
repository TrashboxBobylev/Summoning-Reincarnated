...
public class vLegacy_Changes {
    public static void addAllChanges( ArrayList<ChangeInfo> changeInfos ){
        ...
        ChangeInfo changes = new ChangeInfo( "Legacy-v1.0", true, "");
        changes.hardlight( Window.TITLE_COLOR);
        changes.addButton( new ChangeButton(Icons.get(Icons.BOBYLEV), "Developer Information",
    ...
    public static void add_1_2_5_Changes(ArrayList<ChangeInfo> changeInfos){
        ChangeInfo changes = createChangeInfo(changeInfos, "Legacy-v1.2.5", true, Window.TITLE_COLOR);
        changes = createChangeInfo(changeInfos, "v1.2.5a", false, 0xd1bb00);
        changes.addButton(new ChangeButton(Icons.get(Icons.BOBYLEV), "Developer Information",
        ...
        changes = createChangeInfo(changeInfos, "Dev", false, Window.TITLE_COLOR);
        changes.addButton(new ChangeButton(Icons.get(Icons.BOBYLEV), "Developer Information",
                "_-_ Released August 30th, 2023\n" +
                        "_-_ 564 days after 1.2.4"
        ));

        changes = createChangeInfo(changeInfos, "New Content", false, 0x10bb00);
        changes.addButton( new ChangeButton(ChangeIcons.V062_ROGUE_HEROARM, "Rogue rework (part 2)",
        ...
        changes.addButton(new ChangeButton(ChangeIcons.V041_PLATE, "Defense",
        ...
        changes = createChangeInfo(changeInfos, "Changes", false, 0xd1bb00);
        changes.addButton( new ChangeButton(ChangeIcons.V090_TALENTS, "Balance changes",
        ...
        changes.addButton( new ChangeButton(ChangeIcons.PD_RAT, "Enemy changes",
    ...
    public static void add_1_2_4_Changes(ArrayList<ChangeInfo> changeInfos){
        ChangeInfo changes = createChangeInfo(changeInfos, "Legacy-v1.2.4", true, Window.TITLE_COLOR);

        changes = createChangeInfo(changeInfos, "1.2.4a", false, Window.WHITE);
        ...
        changes = createChangeInfo(changeInfos, "New Content", false, 0x10bb00);
        changes.addButton(new ChangeButton(SummIcons.V124_MAIL_ARMOR, "Armor ranking",
        ...
        changes.addButton(new ChangeButton(ChangeIcons.V093_CROWN, "Armor abilities",
        ...
        changes = createChangeInfo(changeInfos, "Changes", false, 0xd1bb00);
        changes.addButton( new ChangeButton(SummIcons.V124_ELIXIR_ICY, "Frost",
                "_-_ Reworked VFX of frostburn and frost potions to be less performance-taxing."
        ));
        changes.addButton( new ChangeButton(SummIcons.V124_ARTIFACT_HOLDER, "Artifact slots",
    ...
    public static void add_1_1_7_Changes(ArrayList<ChangeInfo> changeInfos) {
        ...
        ChangeInfo changes = createChangeInfo(changeInfos, "Legacy-v1.2.3", true, Window.TITLE_COLOR);

        changes = createChangeInfo(changeInfos, "1.2.3a", false, Window.WHITE);
        changes.addButton( new ChangeButton(ChangeIcons.V061_BUGFIX, Messages.get(ChangesScene.class, "bugfixes"),
                "Fixed:\n" +
        ...
        changes = createChangeInfo(changeInfos, "New Content", false, 0x10bb00);
        changes.addButton(new ChangeButton(SummIcons.V123_MIRROR_OF_FATES, "New Artifacts",
        ...
        changes.addButton(new ChangeButton(SummIcons.V123_PERFUME_BLAST, "Abilities",
                "Added new abilities: \n\n" +
                        "_-_ _Perfume Blast_ - replaces the old Brew of Perfume, spreads the perfume gas that distracts enemies."
        ));
        changes = createChangeInfo(changeInfos, "Changes", false, 0xd1bb00);
        changes.addButton(new ChangeButton(ChangeIcons.V070_ARMBAND, "Artifacts",
        ...
        changes.addButton(new ChangeButton(ChangeIcons.V064_CHALLENGES, "Conducts",
        ...
        changes.addButton( new ChangeButton(ChangeIcons.V061_STAIRS, "Level gen",
        ...
        changes.addButton( new ChangeButton(ChangeIcons.V11_ENERGY, "Alchemical energy",
        ...
        changes = createChangeInfo(changeInfos, "Legacy-v1.2.2", true, Window.TITLE_COLOR);
        ...
        changes.addButton(new ChangeButton(SummIcons.V122_ELEMENTAL_BLAST, "Abilities",
        ...
        changes.addButton(new ChangeButton(ChangeIcons.V063_MAGICMISSILE, "Wands rework",
        ...
        changes.addButton(new ChangeButton(SummIcons.V122_GAME_MODE, "New game modes",
        ...
        changes.addButton( new ChangeButton(ChangeIcons.V062_ROGUE_HEROARM, "Rogue rework (part 1)",
        ...
        changes.addButton(new ChangeButton(SummIcons.V121_GAME_MODE, "Game Mode Changes",
        ...
        changes.addButton(new ChangeButton(SummIcons.V122_MASTERY, "Subclasses",
        ...
        changes.addButton(new ChangeButton(ChangeIcons.V074_SHPX, "ShatteredPD",
        ...
        changes = createChangeInfo(changeInfos, "Legacy-v1.2.1", true, Window.TITLE_COLOR);

        changes = createChangeInfo(changeInfos, "1.2.1b", false, Window.WHITE);
        changes.addButton(new ChangeButton(SummIcons.V121_ENCHANT_TRANSFER,
                "Added enchantment parchment from legacy era.\n\n" +
                        "_-_ Allows to transfer enchantments and glyphs between items."));
        changes.addButton(new ChangeButton(SummIcons.V120_WAND_OF_CONJURATION,
        ...
        changes.addButton(new ChangeButton(ChangeIcons.V25_BOMB,
        ...
        changes = createChangeInfo(changeInfos, "New Content", false, 0x10bb00);
        changes.addButton( new ChangeButton(SummIcons.V121_GAME_MODE, "Game Modes",
        ...
        changes.addButton( new ChangeButton(SummIcons.V121_HUNTRESS, "Huntress changes",
        ...
        changes.addButton( new ChangeButton(SummIcons.V120_ABYSS, "Abyss and Endless mode",
        ...
        changes.addButton( new ChangeButton(SummIcons.V100_ATTUNEMENT, "Tiering",
                "Fixed a huge issue with minion tier being reset at reload."));

        changes.addButton( new ChangeButton(SummIcons.V121_STAR_BLAZING, "Conjurer buffs",
        ...
        changes = createChangeInfo(changeInfos, "Minion Rebalancing", false, 0x5ed8ff);

        changes.addButton(new ChangeButton(SummIcons.V120_FROGGIT_STAFF, "Froggit Staff",
        ...
        changes.addButton(new ChangeButton(SummIcons.V100_GREY_RAT_STAFF, "Gray Rat Staff",
        ...
        changes.addButton(new ChangeButton(SummIcons.V121_SLIME_STAFF, "Slime Staff",
        ...
        changes.addButton(new ChangeButton(SummIcons.V121_SKELETON_STAFF, "Skeleton Staff",
        ...
        changes.addButton(new ChangeButton(SummIcons.V121_CHICKEN_STAFF, "Chicken Staff",
        ...
        changes.addButton(new ChangeButton(SummIcons.V121_FROST_ELEMENTAL_STAFF, "Frost Elemental Staff",
        ...
        changes.addButton(new ChangeButton(SummIcons.V121_WIZARD_STAFF, "Dwarf Wizard Staff",
        ...
        changes.addButton(new ChangeButton(SummIcons.V121_DARK_ROSE, "Dark Rose",
        ...
        changes.addButton(new ChangeButton(SummIcons.V121_IMP_QUEEN_STAFF, "Imp Queen Staff",
        ...
        changes.addButton(new ChangeButton(SummIcons.V121_HACATU_STAFF, "Hacatu's Battlebanner",
        ...
        changes = new ChangeInfo("Legacy-v1.2", true, "");
        changes.hardlight(Window.TITLE_COLOR);
        changeInfos.add(changes);
        ...
        changes = createChangeInfo(changeInfos, "Overhauls", false, 0x5ed8ff);

        changes.addButton( new ChangeButton(SummIcons.V120_FROGGIT_STAFF, "Staves rework",
        ...
        changes.addButton( new ChangeButton(ChangeIcons.V062_ROGUE_HEROARM, "Rogue",
                "Rogue is undergoing some global changes. Assassin and Freerunner are still in the game, but will be replaced in 1.3 patch."));

        changes = createChangeInfo(changeInfos, "New Content", false, Window.SHPX_COLOR);

        changes.addButton( new ChangeButton(SummIcons.V110_HALLS, "Dynamic Dungeon Size",
        ...
        changes.addButton( new ChangeButton(SummIcons.V120_SOUL_OF_YENDOR, "Soul of Yendor",
        ...
        changes.addButton( new ChangeButton(SummIcons.V120_ROPES, "Morshu's wares",
        ...
        changes.addButton( new ChangeButton(SummIcons.V120_WAND_OF_CONJURATION, "New wand",
        ...
        changes = createChangeInfo(changeInfos, "Changes", false, 0xc65c0c);

        changes.addButton(new ChangeButton(ChangeIcons.V074_SHPX, "Shattered PD Port",
        ...
        changes = createChangeInfo(changeInfos, "v1.2.0a & 1.2.0b", false, Window.WHITE);
        ...
        changes.addButton( new ChangeButton(ChangeIcons.V060_RATION, "Food",
    ...
    public static void add_1_1_5_Changes(ArrayList<ChangeInfo> changeInfos) {
        ...
        ChangeInfo changes = new ChangeInfo("Legacy-v1.1.5", true, "");
        changes.hardlight(Window.TITLE_COLOR);
        changeInfos.add(changes);

        changes = createChangeInfo(changeInfos, "v1.1.5b", false, Window.WHITE);

        changes.addButton( new ChangeButton(ChangeIcons.V081_MISC, Messages.get(ChangesScene.class, "misc"),
                "_-_ Fixed crash on Dwarf King.\n\n" +
                        "_-_ Removed ShPD support prompt."));

        changes = createChangeInfo(changeInfos, "v1.1.5a", false, Window.WHITE);

        changes.addButton( new ChangeButton(ChangeIcons.V25_BOMB, "Bomb changes",
        ...
        changes = createChangeInfo(changeInfos, "Changes", false, Window.SHPX_COLOR);
        ...
        changes.addButton( new ChangeButton(ChangeIcons.V080_HEROARM_WARRIOR, "Warrior Subclass Rework!",
    ...
    public static void add_1_1_4_Changes(ArrayList<ChangeInfo> changeInfos) {
        ...
        ChangeInfo changes = new ChangeInfo("Legacy-v1.1.4.2", true, "");
        changes.hardlight(Window.TITLE_COLOR);
        changeInfos.add(changes);
        ...
        changes.addButton(new ChangeButton(Icons.get(Icons.BOBYLEV), "Developer Information",
                "_-_ Released June 29th, 2020\n" +
                        ...
                        "YEEEEEEEEEE"));
        changes = createChangeInfo(changeInfos, "Changes", false, Window.SHPX_COLOR);
        changes.addButton( new ChangeButton(ChangeIcons.V060_RATION, "Reworked hunger",
        ...
        changes.addButton( new ChangeButton(ChangeIcons.V030_DISINTEGRATION, "New wand",
    ...
    public static void add_1_1_3_Changes(ArrayList<ChangeInfo> changeInfos) {
        ...
        ChangeInfo changes = new ChangeInfo("Legacy-v1.1.3", true, "");
        changes.hardlight(Window.TITLE_COLOR);
        changeInfos.add(changes);
        ...
        changes.addButton( new ChangeButton(ChangeIcons.V063_MAGICMISSILE, "Wand Changes",
    ...
    public static void add_1_1_2_Changes(ArrayList<ChangeInfo> changeInfos) {
        ChangeInfo changes = new ChangeInfo("Legacy-v1.1.2", true, "");
        changes.hardlight(Window.TITLE_COLOR);
        changeInfos.add(changes);
        changes = createChangeInfo(changeInfos, "Dev", false, Window.TITLE_COLOR);
        changes.addButton(new ChangeButton(Icons.get(Icons.BOBYLEV), "Developer Information",
        ...
        changes.addButton( new ChangeButton(SummIcons.V111_WAND_OF_CRYSTAL_BULLET, "Changes to WoCB",
        ...
        changes.addButton( new ChangeButton(SummIcons.V112_WAND_OF_STARS, "New Wand",
    ...
    public static void add_1_1_1_Changes(ArrayList<ChangeInfo> changeInfos) {
        ChangeInfo changes = new ChangeInfo("Legacy-v1.1.1", true, "");
        changes.hardlight(Window.TITLE_COLOR);
        changeInfos.add(changes);
        changes = createChangeInfo(changeInfos, "Dev", false, Window.TITLE_COLOR);
        changes.addButton(new ChangeButton(Icons.get(Icons.BOBYLEV), "Developer Information",
        ...
        changes.addButton( new ChangeButton(SummIcons.V111_WAND_OF_CRYSTAL_BULLET, "New Wand",
    ...
    public static void add_1_1_Changes(ArrayList<ChangeInfo> changeInfos){
        ChangeInfo changes = new ChangeInfo( "Legacy-v1.1", true, "");
        changes.hardlight( Window.TITLE_COLOR);
        changeInfos.add(changes);
        changes = createChangeInfo(changeInfos, "Dev", false, Window.TITLE_COLOR);
        changes.addButton( new ChangeButton(Icons.get(Icons.BOBYLEV), "Developer Information",
        ...
        changes.addButton( new ChangeButton(SummIcons.V100_GREY_RAT_STAFF, "Summon weapon rework",
        ...
        changes.addButton( new ChangeButton(SummIcons.V110_ARCANE_NUKE, "Bomb rework",
        ...
        changes.addButton( new ChangeButton(SummIcons.V110_POWER_HOLDER, "Power ups!",
        ...
        changes.addButton( new ChangeButton(SummIcons.V110_HALLS, "Floor 21 rework!",
        ...
        changes.addButton( new ChangeButton(SummIcons.V110_DOG, "New mob and changes",
        ...
        changes.addButton( new ChangeButton(SummIcons.V110_VAMPIRIC, "Vampiric rework",
        ...
        changes.addButton( new ChangeButton(SummIcons.V101_WAND_OF_STENCH, "Wand of Stench rework",
        ...
        changes.addButton( new ChangeButton(SummIcons.V110_SCIMITAR, "Scimitar rework",
        ...
        changes.addButton( new ChangeButton(SummIcons.V110_CRASH, "Crash report system",
    ...
    public static void add_1_0_1_Changes(ArrayList<ChangeInfo> changeInfos ) {
        ChangeInfo changes = new ChangeInfo( "Legacy-v1.0.1", true, "");
        changes.hardlight( Window.TITLE_COLOR);
        changeInfos.add(changes);
        changes = createChangeInfo(changeInfos, "Dev", false, Window.TITLE_COLOR);
        changes.addButton( new ChangeButton(Icons.get(Icons.BOBYLEV), "Developer Information",
        ...
        changes = createChangeInfo(changeInfos, "Changes", false, Window.SHPX_COLOR);
        changes.addButton( new ChangeButton(SummIcons.V100_GOLD, "Gold",
        ...
        changes.addButton( new ChangeButton(ChangeIcons.PD_GHOST, "Sad Ghost quest",
                "_-_ Now shows rewards names\n" +
                        "_-_ Now can give a staff\n"));
        changes.addButton( new ChangeButton(ChangeIcons.V21_SHOPKEEPER, "Shops",
        ...
        changes.addButton( new ChangeButton(SummIcons.V101_CLEAN_WATER, "Clean Water",
        ...
        changes.addButton( new ChangeButton(SummIcons.V101_WAND_OF_STENCH, "Wand of Stench",
        ...
        changes = createChangeInfo(changeInfos, "1.0.1a", false, CharSprite.DEFAULT);
        changes.addButton( new ChangeButton(ChangeIcons.V061_BUGFIX, Messages.get(ChangesScene.class, "bugfixes"),
    ...
    public static void add_General_Changes(ArrayList<ChangeInfo> changeInfos ){
        ChangeInfo changes = createChangeInfo(changeInfos, "General", false, Window.SHPX_COLOR);
        changes.addButton( new ChangeButton(SummIcons.V100_CONJURER, "New Class!",
        ...
        changes.addButton( new ChangeButton(SummIcons.V100_GREY_RAT_STAFF, "Summon Weapons!",
        ...
        changes.addButton( new ChangeButton(SummIcons.V100_ATTUNEMENT, "Attunement",
    ...
    public static void add_Items_Changes(ArrayList<ChangeInfo> changeInfos){
        ChangeInfo changes = createChangeInfo(changeInfos, "Items", false, 0x5ba5ff);
        changes.addButton( new ChangeButton(SummIcons.V100_RING_AGATE, "Ring changes",
        ...
        changes.addButton( new ChangeButton(SummIcons.V100_LOVE_HOLDER, "New artifact!",
        ...
        changes.addButton( new ChangeButton(SummIcons.V100_CONJURER_ARMOR, "Deltarune Robe",
        ...
        changes.addButton( new ChangeButton(SummIcons.V100_ENRAGE, "New spells!",
        ...
        changes.addButton( new ChangeButton(SummIcons.V100_PERFUME_BREW, "New brews!",
        ...
        changes.addButton( new ChangeButton(SummIcons.V100_CLEAVER, "New weapons!",
                "_-_ Added the cleaver, that have low damage and accuracy, but can overkill the enemy with small chance."));
        changes.addButton( new ChangeButton(SummIcons.V100_SLINGSHOT, "New missile weapon!",
                "_-_ Warrior now have the slingshot, that can shoot one stone at time, and upgrades with gaining strength."));
        changes.addButton( new ChangeButton(ChangeIcons.V041_RUNICBLADE, "Runic Blade rework",
    ...
    public static void add_Mobs_Changes(ArrayList<ChangeInfo> changeInfos) {
        ChangeInfo changes = createChangeInfo(changeInfos, "Mobs", false, 0xffc511);
        changes.addButton( new ChangeButton(SummIcons.V100_SNAKE, "New monster in Caves",
        ...
        changes.addButton( new ChangeButton(ChangeIcons.V080_NECROMANCER, "Necromancer",
        ...
        changes.addButton( new ChangeButton(ChangeIcons.V075_TENGU, "New Tengu",
                "Added Tengu fight from Shattered 0.7.5. Nothing are changed."));
        changes.addButton( new ChangeButton(SummIcons.V100_SLIME, "New monster in Demon Halls",
        ...
        changes.addButton( new ChangeButton(SummIcons.V100_FINAL_FROGGIT, "Final Froggits",
    ...
    public static void add_Minor_Changes(ArrayList<ChangeInfo> changeInfos){
        ChangeInfo changes = createChangeInfo(changeInfos, "Other", false, 0x651f66);
        changes.addButton( new ChangeButton(SummIcons.V100_GOLD, "Gold balance changes",
        ...
        changes.addButton( new ChangeButton(ChangeIcons.V070_POTION_CRIMSON, "Healing item changes",
        ...
        changes.addButton( new ChangeButton(SummIcons.V100_UNSTABLE, "Unstable enchantment",
                "Now have rainbow shining as glowing effect."));
        changes.addButton( new ChangeButton(ChangeIcons.V073_KUNAI, "Sneaky weapon changes",
                "Throwing sneaky weapons now doesn't consume a durability, while used with sneak attack"));
        changes.addButton( new ChangeButton(ChangeIcons.V074_SHPX, "Shattered 0.7.5",
                "Added the new camera panning from new Shattered."));
        changes.addButton( new ChangeButton(SummIcons.V100_RESIST, "Resistance",
                "If monsters are resisting the effect, effect's damage now square-rooted rather that halfing."));
        changes.addButton( new ChangeButton(SummIcons.V100_RANKINGS, "Rankings",
