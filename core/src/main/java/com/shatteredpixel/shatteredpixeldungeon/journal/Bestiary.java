...
public enum Bestiary {
	...
	static {
		...
		REGIONAL.addEntities(Rat.class, Snake.class, Dog.class, Gnoll.class, Swarm.class, Crab.class, Slime.class,
				Skeleton.class, Thief.class, DM100.class, Guard.class, Necromancer.class,
				Bat.class, Brute.class, Shaman.RedShaman.class, Shaman.BlueShaman.class, Shaman.PurpleShaman.class, Spinner.class, RattleSnake.class, DM200.class,
				...
				RipperDemon.class, DemonSpawner.class, Succubus.class, Eye.class, Scorpio.class, AttunementConstruct.class,
		...
		NEUTRAL.addEntities(Ghost.class, RatKing.class, Shopkeeper.class, Wandmaker.class, MysteryMerchant.class, Blacksmith.class, Imp.class, Sheep.class, Bee.class);
		...
		ALLY.addEntities(MirrorImage.class, PrismaticImage.class,
				...
				Froggit.class, GrayRat.class, com.shatteredpixel.shatteredpixeldungeon.actors.mobs.minions.Sheep.class,
				GnollHunter.class, MagicMissileMinion.class, Crow.class,
				Robo.class, Wizard.class, FrostElemental.class,
				GooMinion.class, GasterBlaster.class, TriadFighter.class, TriadMagician.class, TriadRanger.class);
