...
import com.shatteredpixel.shatteredpixeldungeon.levels.rooms.special.AttunementPotRoom;
...
public abstract class RegularLevel extends Level {
	...
	protected ArrayList<Room> initRooms() {
		...
		if (Dungeon.mode == Dungeon.GameMode.CHAOS) standards = Random.Int(1, (int) (standards*1.4f));
	...
	protected void createMobs() {
		...
		for (Room room : rooms) {
			if (room instanceof StandardRoom && !((StandardRoom) room).noMobs) {
