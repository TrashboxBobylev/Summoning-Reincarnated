...
public class MysteryMerchantRoom extends SpecialRoom {
	...
	public void paint(Level level) {
        ...
        MysteryMerchant merchant = new MysteryMerchant();
        merchant.pos = level.pointToCell(c);
        level.mobs.add(merchant);
        MysteryMerchant.Stats.updateChapter();
