...
public class WndItemTypes extends WndTabbed {
    ...
    public WndItemTypes(Item item) {
        ...
        IconTitle titlebar = new IconTitle( new ItemSprite(item.image()), Messages.titleCase(Messages.get(WndJournalItem.class, "types")) );
        ...
        for (int i = 1; i <= 3; i++){
            ...
            text.text( ((TypedItem) item).getTypeMessage(i), width );
